...
| [02-正式注册登录与用户绑定.md](02-正式注册登录与用户绑定.md) | 将固定账号登录改为数据库账号、密码哈希和登录会话；保留旧双用户数据，并新增用户绑定邀请确认流程。 |
| [03-每日信息焦点.md](03-每日信息焦点.md) | 共享四类每日热门：固定 RSS 快照、third 中文编辑、两日历史、7 日去重和首页抽屉展示。 |
...
| 共享每日热门 | `newsfocus` | `third/news_focus`、`features/newsfocus` |
